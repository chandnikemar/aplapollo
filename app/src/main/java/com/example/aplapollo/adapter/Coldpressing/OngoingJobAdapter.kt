...
class OngoingCRMJobAdapter(
    ...
    private val jobList: MutableList<OngoingCRMJobResponse>,
    private val onItemClick: (OngoingCRMJobResponse) -> Unit,
    private val onDeleteClick: (OngoingCRMJobResponse) -> Unit,
    private val onReprintClick: (OngoingCRMJobResponse) -> Unit
    ...
    override fun onBindViewHolder(holder: JobViewHolder, position: Int) {
        ...
        val child = job.crmJobDetailsResponse?.firstOrNull()
...
//            holder.ivDelete?.visibility = if (isCompleted) View.GONE else View.VISIBLE
    ...
    private fun showCompletedDialog(
        ...
        val child = job.crmJobDetailsResponse?: emptyList()
        if (child.isEmpty()) {
