...
class OngoingJobAdapter(
    ...
    override fun onBindViewHolder(holder: JobViewHolder, position: Int) {
        ...
        holder.tvBarcode.text = stock?.barcode ?: "-"
        holder.tvWidth.text = stock?.width?.toString() ?: "-"
        holder.tvThickness.text = stock?.thickness?.toString() ?: "-"
        holder.tvGrade.text = stock?.grade ?: "-"
