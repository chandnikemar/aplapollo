    ...
    class OngoingJobAdapter(
        ...
        private val jobList: MutableList<OngoingJobResponse>,
        private val onItemClick: (OngoingJobResponse) -> Unit,
        private val onDeleteClick: (OngoingJobResponse) -> Unit,
        private val onReprintClick: (OngoingJobResponse) -> Unit
        ...
        override fun onBindViewHolder(holder: JobViewHolder, position: Int) {
            ...
            val child = job.hRSlittingJobDetailsResponse?: emptyList()
...
//            holder.ivDelete?.visibility = if (isCompleted) View.GONE else View.VISIBLE
        ...
        private fun showCompletedDialog(
            ...
            val details = job.hRSlittingJobDetailsResponse ?: emptyList()
            ...
            if (details.isEmpty()) {
                ...
                tvBarcode.text = details.joinToString("\n") {
                    it.barcode ?: "-"
                }

                tvWeight.text = details.joinToString("\n") {
                    "${it.weight ?: 0.0} Ton"
                }
            }
